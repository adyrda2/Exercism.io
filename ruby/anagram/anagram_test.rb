%w(cashregister Carthorse radishes)#!/usr/bin/env ruby
gem 'minitest', '>= 5.0.0'
...
class AnagramTest < Minitest::Test
  ...
  def test_words_are_anagrams 
    detector = Anagram.new('lemon')
    anagrams = detector.match %w(melon lime)
    assert_equal ['melon'], anagrams
  end 
end
